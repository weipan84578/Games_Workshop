...
const PlantDefs = [
  { id: 'P01', name: '向日葵', emoji: '🌻', cost: 50, cooldown: 5000, hp: 300, kind: 'sun', produceInterval: 10000 },
  { id: 'P02', name: '豌豆射手', emoji: '🌱', cost: 75, cooldown: 4000, hp: 300, kind: 'shooter', attackInterval: 1500, damage: 24, projectile: 'pea' },
  { id: 'P03', name: '寒冰射手', emoji: '❄️', cost: 150, cooldown: 6000, hp: 300, kind: 'shooter', attackInterval: 1650, damage: 24, projectile: 'ice', effect: 'slow' },
  { id: 'P04', name: '雙發射手', emoji: '🌿', cost: 150, cooldown: 6000, hp: 400, kind: 'shooter', attackInterval: 1700, damage: 24, projectile: 'pea', shots: 2 },
  { id: 'P05', name: '櫻桃炸彈', emoji: '🍒', cost: 150, cooldown: 28000, hp: 999, kind: 'bomb', blast: 'cross', blastDamage: 1199 },
  { id: 'P06', name: '堅果牆', emoji: '🥔', cost: 50, cooldown: 12000, hp: 4000, kind: 'wall' },
  { id: 'P07', name: '尖刺草', emoji: '🌵', cost: 125, cooldown: 6000, hp: 300, kind: 'spike', attackInterval: 1100, damage: 24 },
  { id: 'P08', name: '火焰射手', emoji: '🔥', cost: 200, cooldown: 12000, hp: 300, kind: 'shooter', attackInterval: 1550, damage: 48, projectile: 'fire', effect: 'burn' },
  { id: 'P09', name: '三線射手', emoji: '☘️', cost: 325, cooldown: 6000, hp: 400, kind: 'threepeater', attackInterval: 1800, damage: 24, projectile: 'pea' },
  { id: 'P10', name: '催眠菇', emoji: '🍄', cost: 100, cooldown: 12000, hp: 300, kind: 'hypno' },
  { id: 'P11', name: '雙子向日葵', emoji: '🌼', cost: 100, cooldown: 10000, hp: 300, kind: 'sun', produceInterval: 9000, sunValue: 50 },
  { id: 'P12', name: '機槍豌豆', emoji: '🫛', cost: 250, cooldown: 10000, hp: 350, kind: 'shooter', attackInterval: 1200, damage: 22, projectile: 'pea', shots: 4 },
  { id: 'P13', name: '玉米投手', emoji: '🌽', cost: 100, cooldown: 7000, hp: 300, kind: 'lobber', attackInterval: 2300, damage: 42, projectile: 'corn', effect: 'stun' },
  { id: 'P14', name: '西瓜投手', emoji: '🍉', cost: 300, cooldown: 11000, hp: 300, kind: 'lobber', attackInterval: 2600, damage: 84, projectile: 'melon', splash: 54 },
  { id: 'P15', name: '冰西瓜', emoji: '🧊', cost: 425, cooldown: 14000, hp: 300, kind: 'lobber', attackInterval: 2800, damage: 78, projectile: 'ice-melon', splash: 48, effect: 'slow' },
  { id: 'P16', name: '辣椒', emoji: '🌶️', cost: 125, cooldown: 24000, hp: 999, kind: 'rowBomb', blastDamage: 1199 },
  { id: 'P17', name: '土豆地雷', emoji: '🧨', readyEmoji: '💣', cost: 25, cooldown: 18000, hp: 300, kind: 'mine', armTime: 8000, blastDamage: 840 },
  { id: 'P18', name: '南瓜罩', emoji: '🎃', cost: 125, cooldown: 16000, hp: 2500, kind: 'wall' },
  { id: 'P19', name: '大嘴花', emoji: '🌺', cost: 150, cooldown: 14000, hp: 400, kind: 'chomper', attackInterval: 6500, damage: 1199 },
  { id: 'P20', name: '星星果', emoji: '⭐', cost: 125, cooldown: 7000, hp: 300, kind: 'star', attackInterval: 1700, damage: 22, projectile: 'star' },
  { id: 'P21', name: '毒菇', emoji: '☠️', cost: 75, cooldown: 7000, hp: 250, kind: 'shooter', attackInterval: 1900, damage: 14, projectile: 'poison', effect: 'poison' },
  { id: 'P22', name: '磁力菇', emoji: '🧲', cost: 125, cooldown: 14000, hp: 300, kind: 'magnet', attackInterval: 7000 },
  { id: 'P23', name: '咖啡豆', emoji: '☕', cost: 75, cooldown: 10000, hp: 180, kind: 'aura', aura: 'haste', attackInterval: 1000 },
  { id: 'P24', name: '蘆葦閃電', emoji: '⚡', cost: 150, cooldown: 9000, hp: 300, kind: 'chain', attackInterval: 2100, damage: 42, chains: 3, chainRange: 1.75 },
  { id: 'P25', name: '竹刺炮', emoji: '🎋', cost: 175, cooldown: 9000, hp: 320, kind: 'shooter', attackInterval: 1900, damage: 30, projectile: 'pierce', pierce: 3 },
  { id: 'P26', name: '回力花', emoji: '🪃', cost: 125, cooldown: 8000, hp: 300, kind: 'boomerang', attackInterval: 2200, damage: 34, pierce: 2 },
  { id: 'P27', name: '治療草', emoji: '💚', cost: 100, cooldown: 13000, hp: 280, kind: 'healer', attackInterval: 3000, heal: 80 },
  { id: 'P28', name: '寒霜薄荷', emoji: '🪻', cost: 175, cooldown: 19000, hp: 300, kind: 'freezeAura', attackInterval: 2500, damage: 12 },
  { id: 'P29', name: '風車草', emoji: '🌀', cost: 150, cooldown: 12000, hp: 300, kind: 'shooter', attackInterval: 2100, damage: 22, projectile: 'wind', effect: 'knockback' },
  { id: 'P30', name: '金盞花', emoji: '🏵️', cost: 75, cooldown: 7000, hp: 260, kind: 'sun', produceInterval: 14000, sunValue: 15, scoreValue: 120 },
  { id: 'P31', name: '火焰西瓜', emoji: '🍈', cost: 425, cooldown: 14000, hp: 300, kind: 'lobber', attackInterval: 2800, damage: 78, projectile: 'fire-melon', splash: 48, effect: 'burn' },
  { id: 'P32', name: '高大堅果', emoji: '🪵', cost: 150, cooldown: 20000, hp: 8000, kind: 'wall', tall: true }
];
