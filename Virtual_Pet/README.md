...
Pure HTML/CSS/Vanilla JavaScript virtual pet game built to run directly from `index.html`.

## Open

Double-click `index.html`, or open it in a browser through the local filesystem. The game does not require `npm install`, a bundler, a dev server, ES modules, or `fetch()`.
