...
VP.LANG_JA = {
  ...
  instructions: {
    ...
    cards: {
      actions: [
        { icon: "🔥", title: "あたためる", body: "たまご期はあたためるとなでるだけ。ほかのお世話は孵化後に解放されます。" },
        ...
        { icon: "⭐", title: "トレーニング", body: "成熟期から解放。成長が早いぶん体力と満腹を多く使います。" },
      ...
      stats: [
        ...
        { icon: "❤", title: "健康", body: "ほかの状態から決まる大切な値です。老年期に入ると自然に下がり始めます。" }
      ],
      growth: [
        ...
        { icon: "🍂", title: "老年期", body: "老年期に入った時点で健康が下がり始め、最後は自然に一生を終えます。" }
      ],
      encyclopedia: [
        { icon: "▦", title: "育成図鑑", body: "老年期まで育てたペットが図鑑に解放されます。" },
        { icon: "❓", title: "未知のペット", body: "たまごの中身は孵化まで不明です。未育成のペットはロック表示です。" },
        { icon: "50", title: "50 種類", body: "ドラゴン、魚、猫、犬、牛など10系統、合計50種類のペットがいます。" }
      ],
      save: [
        { icon: "💾", title: "自動セーブ", body: "たまご選択、孵化結果、お世話、図鑑、設定が保存されます。" },
