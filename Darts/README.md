...
- Modes: 501, 301, 701, Cricket, Around the Clock.
- Opponents: 1 to 3 AI players, selected after pressing Start game.
...
- Scoring: Double Out for 501/301, exact-zero 701, bust handling, Cricket marks/scoring, and Around the Clock progression.
...
- Confirm 501/301 bust restores the score from the start of the turn and 701 wins on exact zero without Double Out.
