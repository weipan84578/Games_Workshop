(function (root) {
  ...
  root.AutoBattlerLang["zh-TW"] = {
    ...
    game: {
      ...
      refreshed: "商店刷新完成！",
      bought: "買到 {name}！",
      xpBought: "所有棋子獲得 {amount} 點經驗",
      unitXp: "{name} 吃牌，獲得 {amount} 點經驗",
      starUp: "{name} 升到 {star} 星！",
    ...
    help: {
      ...
      economy: {
        ...
        steps: [
          ...
          { title: "投資卡牌經驗", text: "花 4 金幣讓所有已擁有棋子增加 4 點卡牌經驗；玩家等級仍由回合結算經驗提升。" }
        ],
      ...
      shop: {
        ...
        steps: [
          ...
          { title: "比較費用", text: "高費棋子更稀有，低費棋子則更容易收集並互相吃牌，沒有唯一答案。" }
        ],
      ...
      merge: {
        title: "吃牌累積經驗，最高五星",
        intro: "同名棋子不論目前星數都能互相吃牌，被吃掉的棋子會轉成經驗。",
        steps: [
          { title: "同名就能吃牌", text: "棋盤與備戰區的同名棋子會一起計算，不要求相同星數。" },
          { title: "經驗滿就升星", text: "每次吃牌增加 1 點卡牌經驗，經驗條滿後立即升高一星。" },
          { title: "突破五星", text: "一到五星的能力係數為 1.0、1.8、3.2、4.8、6.8；五星後不再升級。" }
        ],
        callout: "購買卡牌經驗會同時提升所有已擁有棋子的經驗。"
      },
      synergy: {
        title: "羈絆讓小隊彼此發光",
