...
- Candy purchases and experience purchases support quantities up to 9,999. Candy Festival halves the current regular-candy price, discounts experience by 40%, and shows its localized notice inside the home `.pet-stage__bubble`; without the event, the original home message returns.
