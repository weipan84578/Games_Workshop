(function (PSG) {
  ...
  function start() {
    try {
      ...
      console.error(error);
      document.getElementById('scene-root').innerHTML = '<section class="boot-card card"><h1>⚠</h1><h2>Unable to start</h2><p>' + PSG.utils.dom.escape(error.message) + '</p><p>Please keep every project file in the same folder and reload index.html.</p></section>';
    }
  }
