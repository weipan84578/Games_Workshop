(function (PSG) {
  ...
  PSG.pet.play = {
    perform: function (save) {
      ...
      var available = ids.filter(function (id) { return !(lastTwo.length === 2 && lastTwo[0] === id && lastTwo[1] === id); });
      var rng = new PSG.utils.RNG(PSG.utils.seedFrom(save.ranking.rankingSeed, save.day.number, save.day.rngCounter++, 'play'));
      ...
      save.day.recentPlayIds.push(id); save.day.recentPlayIds = save.day.recentPlayIds.slice(-2);
