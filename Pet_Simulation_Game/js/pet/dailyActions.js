(function (PSG) {
  ...
  PSG.pet.daily = { moodMultiplier: moodMultiplier, can: can, applyFixed: applyFixed, beginBattle: beginBattle, finishBattle: finishBattle, nextDay: nextDay };
})(window.PSG);
