(function (global) {
  global.UNITS_DATA = {
    ...
    scout: {
      ...
      attribute: "normal", attackType: "melee", size: 19
    },
    guard: {
    ...
    catapult: {
      ...
      attribute: "red", attackType: "ranged", size: 24
    },
    berserker: {
      ...
      attribute: "red", attackType: "melee", size: 24, special: true
    },
    frostMage: {
      ...
      attribute: "angel", attackType: "ranged", size: 22, special: true
    },
    thunderMage: {
      ...
      attribute: "demon", attackType: "ranged", size: 23, special: true
    },
    guardian: {
    ...
    summoner: {
      ...
      abilityCooldown: 8, attribute: "normal", attackType: "support", size: 26, special: true
    },
    boss: {
      id: "boss", nameKey: "unit_boss_name", descriptionKey: "unit_boss_desc", roleKey: "unit_role_boss",
      icon: "👑", color: "#8b4d9e", hp: 2200, atk: 156, speed: 18, range: 48, cost: 0, cooldown: 2.3,
      attribute: "demon", attackType: "melee", size: 43, defense: .4, isBoss: true
    }
  };
